...
class AddDepartmentsRoute extends PageRouteInfo<void> {
  const AddDepartmentsRoute({List<PageRouteInfo>? children})
    : super(AddDepartmentsRoute.name, initialChildren: children);
...
class MeetingDetailRoute extends PageRouteInfo<void> {
  const MeetingDetailRoute({List<PageRouteInfo>? children})
    : super(MeetingDetailRoute.name, initialChildren: children);
...
class ProkerDetailRoute extends PageRouteInfo<void> {
  const ProkerDetailRoute({List<PageRouteInfo>? children})
    : super(ProkerDetailRoute.name, initialChildren: children);
...
class QrAttendanceRoute extends PageRouteInfo<void> {
  const QrAttendanceRoute({List<PageRouteInfo>? children})
    : super(QrAttendanceRoute.name, initialChildren: children);
...
class SelectRoleRoute extends PageRouteInfo<void> {
  const SelectRoleRoute({List<PageRouteInfo>? children})
    : super(SelectRoleRoute.name, initialChildren: children);
...
class Step2TimelineRoute extends PageRouteInfo<void> {
  const Step2TimelineRoute({List<PageRouteInfo>? children})
    : super(Step2TimelineRoute.name, initialChildren: children);
...
class Step3ApprovalRoute extends PageRouteInfo<void> {
  const Step3ApprovalRoute({List<PageRouteInfo>? children})
    : super(Step3ApprovalRoute.name, initialChildren: children);
...
class Step4PreparationRoute extends PageRouteInfo<void> {
  const Step4PreparationRoute({List<PageRouteInfo>? children})
    : super(Step4PreparationRoute.name, initialChildren: children);
